...
export function JsonEditor({
  ...
  return (
    <div className={cn("relative flex flex-col w-full h-full min-h-[300px] border rounded-lg bg-gray-50 dark:bg-gray-900 overflow-hidden", 
      ...
      <div className="absolute left-0 top-0 bottom-0 w-10 bg-gray-100 dark:bg-gray-950 border-r border-gray-200 dark:border-gray-800 text-right pr-2 py-4 select-none pointer-events-none text-xs text-gray-400 font-mono leading-relaxed overflow-hidden">
